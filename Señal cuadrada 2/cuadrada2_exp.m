%% Señal Cuadrada 2 - Resultados experimentales
clear;
clc;
close all;
...
archivoTiempo = 'datos cuadrada 2.csv';
...
archivoFFT = 'datos cuadrada 2 FFT.csv';
...
ylabel('Magnitud (dB)')
title('FFT experimental de la señal cuadrada 2')
