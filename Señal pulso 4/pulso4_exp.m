%% Pulso 4 - Resultados experimentales
clear;
clc;
close all;
...
archivoTiempo = 'DATOS PULSO 4.csv';
...
archivoFFT = 'DATOS PULSO 4 FFT.csv';
...
xlabel('Tiempo (s)');
ylabel('Voltaje (V)');
title('Señal de pulso 4 experimental');
...
plot(frecuencia,magnitud,'LineWidth',1.3);

grid on;

xlabel('Frecuencia (Hz)');
ylabel('Magnitud (dB)');
title('FFT experimental del pulso 4');
...
armonicos = [0 2500 5000 7500 10000 12500 ...
