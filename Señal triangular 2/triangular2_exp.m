%% Señal Triangular 2 - Resultados experimentales
clear;
clc;
close all;
...
archivoTiempo = 'DATOS TRIANGULAR 2.csv';
...
archivoFFT = 'DATOS TRIANGULAR 2 FFT.csv';
...
xlabel('Tiempo (s)')
ylabel('Voltaje (V)')
title('Señal triangular 2 experimental')
...
ylabel('Magnitud (dB)')
title('FFT experimental de la señal triangular 2')
...
armonicos = [0 2500 7500 12500 17500 22500];

%% Buscar el punto experimental más cercano
