%% Señal Cuadrada 1 - Resultados experimentales
clear;
clc;
close all;
...
archivoTiempo = 'datos cuadrada 1.csv';
...
archivoFFT = 'datos cuadrada 1 FFT.csv';
...
xlabel('Tiempo (s)')
ylabel('Voltaje (V)')
title('Señal cuadrada experimental')
...
ylabel('Magnitud (dB)')
title('FFT experimental de la señal cuadrada')
...
armonicos = [2500 7500 12500 17500 22500];
