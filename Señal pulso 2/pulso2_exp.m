%% Señal Pulso 2 - Resultados experimentales
clear;
clc;
close all;
...
archivoTiempo = 'DATOS PULSO 2.csv';
...
archivoFFT = 'DATOS PULSO 2 FFT.csv';
...
xlabel('Tiempo (s)')
ylabel('Voltaje (V)')
title('Señal de pulso 2 experimental')
...
ylabel('Magnitud (dB)')
title('FFT experimental del pulso 2')
...
armonicos = [2500 5000 7500 10000 12500 15000 17500 20000 22500];
