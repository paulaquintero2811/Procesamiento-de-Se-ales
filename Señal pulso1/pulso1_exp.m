%% Señal Pulso 1 - Resultados experimentales
clear;
clc;
close all;
...
archivoTiempo = 'DATOS PULSO 1.csv';
...
archivoFFT = 'DATOS PULSO 1 FFT.csv';
...
xlabel('Tiempo (s)')
ylabel('Voltaje (V)')
title('Señal de pulso 1 experimental')
...
ylabel('Magnitud (dB)')
title('FFT experimental del pulso 1')
