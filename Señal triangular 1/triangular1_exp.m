%% Señal Triangular 1 - Experimental
clear;
clc;
close all;
...
archivoTiempo = 'datos triangular 1.csv';
...
archivoFFT = 'DATOS TRIANGULAR 1 FFT.csv';
...
xlabel('Tiempo (s)')
ylabel('Voltaje (V)')
title('Señal triangular experimental')

%% ==========================
% Gráfica FFT experimental
% ==========================
...
% (para usar después en las conversiones)
